...
class RallongebudgetController extends Controller
{
  public function index()
  {
    ...
    $projetdatat = Project::where('id', $IDP)->first();
  ...
  public function fetchAll()
  {
    ...
    if ($data->count() > 0) {
      ...
      $output .= '
        <table id="dtHorizontalVerticalExample" class="table table-striped table-bordered table-sm  table-centered align-middle table-nowrap mb-0" cellspacing="0"
        width="100%">
        <thead>
          <tr >
            <th ><b>#</b></th>
