          ...
          <div class="col-xl-8" style="margin:auto">
              <div class="card">
                <div class="card-header page-title-box d-sm-flex align-items-center justify-content-between" style="padding: 0.40rem 1rem;">
                          ...
                          <h5 class="mb-sm-0"><i class="fa fa-university"></i> Listes des IOV (Indicateurs d'objectivement vérifiable)</h5>
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
          ...
          <div class="modal-body">
              <input class="form-control" id="libelle" name="libelle" type="text" placeholder="Entrer l'abreviation" required /> <br>
              <input class="form-control" id="description" name="description" type="text" placeholder="Entrer la description" required /> 
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <form method="POST" id="editform">
            ...
            @csrf
            <div class="modal-header">
              <h5 class="modal-title" id="verticallyCenteredModalLabel"><i class="fa fa-edit"></i> Modification IOV </h5>
            ...
            <div class="modal-body">
              ...
              <input class="form-control" name="bdescription" id="bdescription" type="text" placeholder="Entrer function"  required />
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger waves-effect" data-bs-dismiss="modal">Fermer</button>
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.status == 200) {
            ...
            toastr.success(
                          "IOV enregistrer avec succès!", // Message
                          "Succès !", // Titre
                          {
          ...
          if (response.status == 201) {
            ...
            toastr.error(
                          "Attention: Libellé IOV existe déjà !", // Message
                          "Error !", // Titre
                          {
                              closeButton: true, // Ajoute un bouton de fermeture
                              progressBar: true, // Affiche une barre de progression
          ...
          if (response.status == 202) {
            toastr.error("L'IOV  existe déjà !", "Erreur");
            $("#addModal").modal('show');
            $("#add").html('<i class="fa fa-cloud-upload-alt"></i> Sauvegarder');
            document.getElementById("add").disabled = false;
          }
