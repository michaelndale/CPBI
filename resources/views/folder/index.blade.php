...
@section('page-content')
            ...
            <div class="modal-content">
                <form id="add_folder_form" autocomplete="off">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="addDealModalTitle"><i class="fa fa-plus-circle"></i>  Nouvelle dossier</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="sendFolder" id="sendFolder"  class="btn btn-primary waves-effect waves-light"> <i class="fa fa-cloud-upload-alt"></i> Sauvegarder</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    ...
    <div class="modal fade" id="editFolderModal" tabindex="-1" role="dialog" aria-labelledby="editFolderModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <form id="edit_folder_form" autocomplete="off">
                    ...
                    <div class="modal-body">
                        ...
                        <input class="form-control" name="flibelle" id="flibelle" type="text"  placeholder="Entrer dossier" required />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger waves-effect" data-bs-dismiss="modal">Fermer</button>
