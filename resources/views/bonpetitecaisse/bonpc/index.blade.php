  ...
  <div class="page-content">
    <div class="card shadow-none border border-300 mb-3" data-component-card="data-component-card" >
     ...
     <div class="card-header page-title-box d-sm-flex align-items-center justify-content-between" style="padding: 0.40rem 1rem;">                 
          <h4 class="mb-sm-0"><i class="fa fa-list"></i> Liste des Bon de Petite Caisse (B.P.C) </h4>
              <div class="page-title-right">
                <a href="#" class="btn btn-outline-primary rounded-pill me-1 mb-1 btn-sm" id="fetchDataLink"> <i class="fas fa-sync-alt"></i> Actualiser</a>
                <a href="javascript::;" class="btn btn-outline-primary rounded-pill me-1 mb-1 btn-sm" chauffeur="button" data-bs-toggle="modal" data-bs-target="#addDealModal" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"> <i class="fa fa-plus-circle"></i> Ajouter la petite caisse </a>
          </div>
      </div>
