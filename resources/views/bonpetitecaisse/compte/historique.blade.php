<div class="page-title-right">
  <div class="input-group mb-3">
    ...
    <div class="input-group-append">
      <button class="btn btn-outline-primary btn-sm" id="searchBetweenDates" title="Rechercher"><i class="fa fa-search"></i> Recherche</button>
    </div> &nbsp; &nbsp; &nbsp; &nbsp;
    <div class="float-end">
      <!-- Bouton d'impression -->
    </div>
...
<form method="POST" id="addOnCaisse"> <!-- Utilisation de id="modifierLigneForm" au lieu de id="modifierLigneModal" pour le formulaire -->
  @method('post')
  @csrf
  ...
  <div class="table-repsonsive">
    ...
    <table class="table table-striped table-sm fs--1 mb-0">
      ...
      <tr style="background-color: rgba(255, 0, 0, 0.3);">
        <th colspan="2"><i class="fa fa-plus-circle"></i> <strong>Clôture du mouvement de caisse </strong> </th>
      </tr>
      <tr>
      ...
      <tr>
        <td>
          <div class="col-sm-12 col-lg-12 col-xl-12 ">
            <select type="text" class="form-control form-control-sm" name="verifie_par" id="verifie_par" required>
        ...
        <td>
          <select type="text" class="form-control form-control-sm" name="approuver_par" id="approuver_par" required>
            <option disabled="true" selected="true" value="">--Sélectionner personnel --</option>
            @foreach ($personnel as $personnels)
            <option value="{{ $personnels->userid }}">{{ $personnels->nom }} {{ $personnels->prenom }}</option>
            @endforeach
  ...
  <table>
    ...
    <tr>
      <td><input type="hidden" name="caisseId[]" id="caisseId[]" value="{{ $historiqueComptes->idcc }}"> </td>
    </tr>
    @endforeach
  </table>
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-danger waves-effect" data-bs-dismiss="modal"><i class="fa fa-times"></i> Fermer</button>
    <button type="submit" name="sendCloture" id="sendCloture" class="btn btn-primary waves-effect waves-light"> <i class="fa fa-cloud-upload-alt"></i> Sauvegarder cloture caisse</button>
  </div>
        ...
        success: function(response) {
          try {
            if (response.status == 200) {
              toastr.success("  Clôture du mouvement de caisse fais avec succès. !", "Cloture caisse");
