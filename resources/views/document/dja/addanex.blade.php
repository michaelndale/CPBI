...
@php
    $cryptedId = Crypt::encrypt($datacheck->id);
@endphp
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-8">
                    ...
                    <div class="alert alert-info alert-dismissible fade show mb-0" role="alert">
                        ...
                        Vous pouvez faire le scanner et l'envoyer en format (PDF, WORD, EXCEL, POWERPOINT).
              ...
              style="padding: 0.3rem 3rem;">
                            ...
                            <div class="row g-3 justify-content-between align-items-end">
                                <div class="col-12 col-md">
                                    <h2 class="card-title mb-1">
                                        <i class="mdi mdi-plus-circle"></i>  Annex document DJA (N° {{ $datacheck->numerodjas }})
                                    </h2>
                                </div>
                                ...
                                -->
                                    <a href="{{ route('listdja') }}" class="btn btn-outline-primary rounded-pill btn-sm">
                        ...
                        <div class="card-body p-0">
                                ...
                                <form id="annexeForm" method="POST" action="{{ route('updat_annex_dja', $datacheck->id) }}" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                    @method('PUT')
