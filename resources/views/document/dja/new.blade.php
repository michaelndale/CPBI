            ...
            <div class="row">
                <div class="col-12" style="margin:auto">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><i class="fa fa-folder-plus"></i> MOdification du DEMANDE ET JUSTIFICATION D'AVANCE (DJA) N<sup>o</sup> : {{ $data->numerudja }} </h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-2">
                                                            ...
                                                            @endphp
                                                            <input  type="text" value="{{ $benefNom }}" class="form-control form-control-sm" readonly style="background-color:#c0c0c0"/>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-2">
                                                            ...
                                                            @php
                                                            $adresse_benef = collect($numerofeb)->pluck('adresse')->join(', ');
                                                        @endphp
                                                        
                                                        <input  type="text" value="{{ $adresse_benef }}" class="form-control form-control-sm"  rreadonly style="background-color:#c0c0c0"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-2">
                                                            ...
                                                            @endphp
                                                            <input  type="text" value="{{ $benefPhone_un }}" class="form-control form-control-sm"  readonly style="background-color:#c0c0c0"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-2">
                                                            ...
                                                            @php
                                                                // Join the 'numerofeb' values with commas
                                                                $benefPhone_deux = $numerofeb->pluck('telephonedeux')->join(', ');
                                                            @endphp
                                                            <input  type="text" value="{{ $benefPhone_deux  }}" class="form-control form-control-sm"  readonly style="background-color:#c0c0c0"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-2">
                                                            ...
                                                            @php
                                                            // Join the 'numerofeb' values with commas
                                                            $benefPhone_decription = $numerofeb->pluck('description')->join(', ');
                                                        @endphp
                                                            <div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="mb-2">
                                                            ...
                                                            <input name="fond_recu_le" type="date"
                                                                class="form-control form-control-sm" value="{{ $data->fond_recu_le }}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-2">
                                                            ...
                                                            @endphp
                                                            <input  type="text" name="" value="{{ $referenceFeb }}" class="form-control form-control-sm" readonly style="background-color:#c0c0c0"/>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-2">
                                                            ...
                                                            <input  type="text"
                                                                class="form-control form-control-sm" value="{{ $data->nume_dap }}" readonly style="background-color:#c0c0c0"/>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-2">
                                                            ...
                                                            <input name="ovcheque" type="text"
                                                                class="form-control form-control-sm" value="{{ $data->cho }}" readonly style="background-color:#c0c0c0"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="mb-2">
                                                            ...
                                                            <input name="ligne_budgetaire" type="text"
                                                                class="form-control form-control-sm" value="{{ $ligneB }}" readonly style="background-color:#c0c0c0"/>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-2">
                                                            ...
                                                            <input name="montant_avance_un" type="text" value="{{ $data->montant_avance_un }}" 
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-2">
                                                            ...
                                                            <input name="devise" type="text"
                                                                class="form-control form-control-sm" value="{{ $devise }}" readonly style="background-color:#c0c0c0"/>
