...
<button class="btn btn-sm  preview-btn ms-2" type="button" data-bs-toggle="modal" data-bs-target="#scrollingLong2" style="background-color:#228B22; color:white" data-keyboard="false" data-backdrop="static"><span class="me-2" data-feather="plus"></span>Nouvel fiche DJA</button></nav>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm fs--1 mb-0">
                            <tbody class="list">
                                <tr>
                                    ...
                                    Présumé Bénéficiaire/Fournisseur/<br>Prestataire à payer:
                                ...
                                <tr>
                                    <td class="align-middle ps-3 name">DESCRIPTION/MOTIF:
                                    </td>
                                    <td class="align-middle email" colspan="6">
                                        <textarea type="text" class="form-control" name="titre" id="titre"> </textarea>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="align-middle ps-3 name">Les fonds devront être reçus le
                                    </td>
                                    <td class="align-middle email" colspan="1">
                                        <input type="text" class="form-control" name="titre" id="titre" style="width: 100%" />
                                    </td>

                                    <td class="align-middle ps-3 name">  Référence (s) : FEB Nº
                                    </td>
                                ...
                                <tr>
                                <td class="align-middle ps-3 name" >OV/CHQ Nº </td>
                                    <td class="align-middle email" colspan="1">
                                        <input type="text" class="form-control" name="titre" id="titre" style="width: 100%">
                                    </td>
                        ...
                        <table class="table table-striped table-sm fs--1 mb-0">
                            <tbody class="list">
                                ...
                                <tr>
                                <td class="align-middle ps-3 name" >Montant de l'avance  :
                                </td>
                                    <td class="align-middle email" colspan="2">
                                        <input type="text" class="form-control" name="titre" id="titre" style="width: 100%">
                                    </td>

                                    <td class="align-middle ps-3 name">Dévise (BIF ou USD): </td>
                                    <td class="align-middle email" colspan="2">
                                        <input type="text" class="form-control" name="titre" id="titre" style="width: 100%">
                                    </td>

                                    <td class="align-middle ps-3 name">Durée de l’avance jours:</td>
                                    <td class="align-middle email" colspan="2">
                                        <input type="text" class="form-control" name="titre" id="titre" style="width: 100%">
                                    </td>
                                </tr>
