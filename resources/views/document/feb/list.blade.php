...
<div class="content">
  <div class="row">
    <div class="col-xl-12" >
      <h4 class="mb-4"><i class="fa fa-folder-open "></i> EXPRESSION DES BESOINS 
        <a class="btn btn-sm btn-phoenix-secondary bg-white hover-bg-100 me-2" href="{{ route('newfeb')}}"> <i class="fa fa-plus-circle"></i> Nouvelle Fiche</a>
      </h4>
