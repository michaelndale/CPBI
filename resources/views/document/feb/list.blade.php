  ...
  <div class="row">
    ...
    <div class="row g-3 justify-content-between align-items-center">
      <div class="col-12 col-md">
        <h4 class="text-900 mb-0" data-anchor="data-anchor"><i class="fa fa-folder-open "></i> Fiche d'Expression des Besoins </h4>
      </div>
        ...
        <table class="table table-striped table-sm fs--1 mb-0">
          <thead>
                            ...
                            @endforeach
                              ...
                              <tr>
                                <td class="align-middle ps-3 name">#0125</td>
                                <td class="align-middle email">Finalisation de construction de service sante </td>
                                <td class="align-middle age">18.01.2013</td>
