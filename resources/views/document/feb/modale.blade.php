...
<div class="modal-dialog modal-xl modal-dialog-centered">
  <div class="modal-content">
                ...
                <tbody class="list">
                    ...
                    <tr>
                        ...
                        <td class="align-middle email" colspan="3">
                            <input type="text" class="form-control" name="ligneid" id="lig" style="width: 100%">
                        </td>
            ...
            <span id="error"></span>
                <table class="table table-striped table-sm fs--1 mb-0" id="item_table">
                    ...
                    <table class="table table-striped table-sm fs--1 mb-0" >
                        ...
                        <tr>
                            <td>
                                <select type="text" class="form-control" name="titre" id="titre">
    ...
    <div class="modal-footer">
        <button class="btn btn-primary" id="addbtn" type="button" style="background-color:#228B22; color:white">Enregistrer</button>
   </div>
  </div>
</div>
</div>
