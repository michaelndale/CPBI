            ...
            <table style=" width:100%" class="table table-striped table-sm fs--1 mb-0" id="mytable">
                ...
                <tr>
                    <td colspan="4"> Fonds reçus par :
                        @php
                        if ($fond_reussi) {
                        $nom = isset($fond_reussi->nom) ? ucfirst($fond_reussi->nom) : 'Nom non disponible';
                        $prenom = isset($fond_reussi->prenom) ? ucfirst($fond_reussi->prenom) : 'Prénom non disponible';
