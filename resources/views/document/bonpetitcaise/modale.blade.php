<div class="modal fade" id="addbpcModal" tabindex="-1" aria-labelledby="addfebModal" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="far fa-file-alt"></i> Fiche Bon de petite caisse (BPC) </h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-sm fs--1 mb-0">
                                <tbody class="list">
                                    ...
                                    <tr>
                                        <td class="align-middle ps-3 name" colspan="2">Je soussigné (nom complet)
                                            <br>
                                            <input type="text" class="form-control form-control-sm" name="nom" id="nom" required>
                                        </td>

                                        <td class="align-middle ps-3 name" colspan="2">
                                            Motif <br>
                                            <input type="text" class="form-control form-control-sm" name="motif" id="motif" required>
                                        </td>
                                    ...
                                    <tr id="enleveceselement">
                                        ...
                                        <td class="align-middle ps-3 name">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="type_identite" id="type_identite" >
                                        </td>
                                        <td>
                                            Numéro de la piece d'identite <br>
                                            <input type="text" class="form-control form-control-sm" name="numero_piece" id="numero_piece" >
                                        </td>
                                        <td>
                                            Adresse <br>
                                            <input type="text" class="form-control form-control-sm" name="adresse" id="adresse" >
                                        </td>
                                        <td>
                                            Téléphone/Email<br>
                                            <input type="text" class="form-control form-control-sm" name="telephone_email" id="telephone_email">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="align-middle ps-3 name">
                                            ...
                                            <input type="number" name="numero" id="numero" class="form-control form-control-sm" style="width: 100%;">
                                            <small id="numero_error" name="numero_error" class="text text-danger"></small>
                                            <small id="numero_info" class="text text-primary"></small>
                                        </td>
