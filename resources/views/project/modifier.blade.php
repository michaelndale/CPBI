                                                            ...
                                                            <div class="col-12 col-md-2">
                                                                <div class="mb-3">
                                                                    <label for="autorisation"
                                                                        class="form-label">Autorisation
                                                                        :</label>
                                                                    <select name="autorisation" id="autorisation" required
                                                                        class="form-control form-control-sm">
                ...
                <div class="modal-body">
                    <form action="{{ route('revision.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" class="form-control" name="nouveau_montant"
                                id="nouveauMontant" required>
                        </div>
