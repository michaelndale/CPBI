                    ...
                    <div class="col-12">
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">{{ $dataProject->title }}
                                <br>
                                <small>
                                    <b><i class="fa fa-info-circle"></i> Statut du projet :</b> <span
                                        class="badge rounded-pill bg-success"> {{ $dataProject->statut }} </span> <br>
                            ...
                            <div class="page-title-right">
                                <div class="dropdown">
                                    ...
                                    <a href="{{ route('key.viewProject', ['project' => $cryptedProjectId, 'exercice' => $cryptedExerciceId]) }}"
                                        class="btn btn-outline-primary rounded-pill me-1 mb-1 btn-sm" type="button"
                                        title="Actualiser"><i class="fas fa-redo-alt"></i> </a>
                                    ...
                                    <a href="{{ route('rallongebudget') }}"
                                        class="btn btn-outline-primary rounded-pill me-1 mb-1 btn-sm" type="button"><i
                                            class="fa fa-list"></i> Budgétisation </a>



                                    <button class="btn btn-outline-primary rounded-pill me-1 mb-1 btn-sm btn-sm dropdown"
                                        type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="fa fa-list"></i> Actions options <i
                                            class="mdi mdi-dots-vertical align-middle "></i>
                                    </button>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('key.editProject', $cryptedProjectId) }}"><i
                                                    class="fa fa-edit font-size-16 align-middle me-2 text-muted"></i>
                                                Modification du projet </a>
                                        </li>

                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ route('exercices.show', $cryptedExerciceId) }}"><i
                                                    class="fa fa-edit font-size-16 align-middle me-2 text-muted"></i>
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('affectation') }}"><i
                                                    class="fa fa-users font-size-16 align-middle me-2 text-muted"></i>
                                                Intervenenant </a>
                                        </li>

                                        <li>
                                            <a class="dropdown-item" href="{{ route('exercices.index') }}"><i
                                                    class="fa  fa-list font-size-16 align-middle me-2 text-muted"></i>
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('activity') }}"><i
                                                    class="fa fa-running font-size-16 align-middle me-2 text-muted"></i>
                                                Activitées</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('listfeb') }}"><i
                                                    class="mdi mdi-file-document-outline font-size-20 align-middle me-2 text-muted"></i>
                                                F.E.B</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('listdap') }}"><i
                                                    class="mdi mdi-file-document-outline font-size-20  align-middle me-2 text-muted"></i>
                                                D.A.P</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('listdja') }}"><i
                                                    class="mdi mdi-file-document-outline font-size-20  align-middle me-2 text-muted"></i>
                                                D.J.A</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('bpc') }}"><i
                                                    class="mdi mdi-file-document-outline font-size-20  align-middle me-2 text-muted"></i>
                                                Bon de petite caisse</a>
                                        </li>

                                        <li>
                                            <a class="dropdown-item" href="{{ route('bailleursDeFonds') }}"><i
                                                    class="fa fa-users font-size-16 align-middle me-2"></i> Bailleurs des
                                                fonds</a>
                                        </li>


                                        <li>
                                            <a class="dropdown-item" href="{{ route('rapportcumule') }}"><i
                                                    class="fa fa-chart-pie font-size-16 align-middle me-2 text-muted"></i>
                                                Rapport cummulatif</a>
                                        </li>


                                        <li>
                                            <a class="dropdown-item" href="{{ route('planoperationnel') }}"><i
                                                    class="fa fa-tasks font-size-16 align-middle me-2 text-muted"></i>
                                                Plan d'action</a>
                                        </li>

                                        <li>
                                            <a class="dropdown-item deleteIcon" id="{{ $dataProject->id }}"
                                                data-title="{{ $dataProject->title }}">
                                                <font color="red"> <i
                                                        class="fas fa-trash-alt font-size-16 align-middle me-2 "></i>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7">
                                        ...
                                        <div class="row gx-0 gx-sm-12">
                                            <div class="col-12">
                                                <table class="lh-sm">
                                                    <tbody>
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Numéro
                                                                projet </td>
                                                            <td class="text-600 fw-semi-bold ps-3"> :
                                                                {{ $dataProject->numeroprojet }}</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Numéro
                                                                exercice</td>
                                                            <td class="text-600 fw-semi-bold ps-3"> :
                                                                {{ $dataProject->numero_e }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Titre
                                                                exercice</td>
                                                            <td class="text-600 fw-semi-bold ps-3"> :
                                                                {{ $dataProject->pexercice }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Statut
                                                                de l'exercice</td>
                                                            <td class="text-600 fw-semi-bold ps-3"> :
                                                        ...
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Titre
                                                                du projet </td>
                                                            <td class="text-600 fw-semi-bold ps-3"> :
                                                                {{ $dataProject->title }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Budget
                                                            </td>
                                                            <td class="text-600 fw-semi-bold ps-3"> :
                                                                {{ number_format($dataProject->budgets, 0, ',', ' ') }}
                                                                {{ $dataProject->devise }} </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-600 fw-semi-bold ps-3"> :
                                                                ...
                                                                {{ ucfirst($responsable->prenom) }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Début
                                                                de l'exécution du projet </td>
                                                            <td class="text-600 fw-semi-bold ps-3">:
                                                                {{ date('d.m.Y', strtotime($dataProject->estart_date)) }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Fin de
                                                                l'exécution du projet </td>
                                                            <td class="text-600 fw-semi-bold ps-3"> :
                                                                {{ date('d.m.Y', strtotime($dataProject->edeadline)) }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">
                                                                Progression du projet </td>
                                                            @php
                                                                $pourcentage = round(
                                                                    ($sommerepartie * 100) / $dataProject->budgets,
                                                                    2,
                                                                );
                                                            ...
                                                            @endphp
                                                            <td class="text-{{ $color }} fw-semi-bold ps-3">: <b>
                                                                    {{ $pourcentage }} %</b>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Région
                                                            </td>
                                                            <td class="text-600 fw-semi-bold ps-3">:
                                                                {{ $dataProject->region }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Lieu
                                                            </td>
                                                            <td class="text-600 fw-semi-bold ps-3">:
                                                                {{ $dataProject->lieuprojet }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Notre
                                                                en période </td>
                                                            <td class="text-600 fw-semi-bold ps-3">:
                                                                {{ $dataProject->eperiode }} (T)</td>
                                                        </tr>

                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Nombres
                                                                des jours </td>
                                                            <td class="text-600 fw-semi-bold ps-3">
                                                                ...
                                                                @php
                                                                    ...
                                                                    $dateDebut = \Carbon\Carbon::parse(
                                                                        $dataProject->estart_date,
                                                                    );
                                                                    $dateFin = \Carbon\Carbon::parse(
                                                                        $dataProject->edeadline,
                                                                    );
                                                        ...
                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Créé
                                                                par </td>
                                                            <td class="text-600 fw-semi-bold ps-3">

                                                                : {{ ucfirst($dataProject->nom) }}
                                                                {{ ucfirst($dataProject->prenom) }}

                                                            </td>
                                                        </tr>

                                                        <tr>
                                                            <td class="align-top py-1 text-900 text-nowrap fw-bold">Créé le
                                                            </td>
                                                            <td class="text-600 fw-semi-bold ps-3">:
                                                                {{ date('d.m.Y', strtotime($dataProject->creele)) }}
                                                            </td>
                                                        </tr>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0 pb-3">
                                <div id="overview-chart" data-colors='["#1f58c7"]' class="apex-charts" dir="ltr">
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header page-title-box d-sm-flex align-items-center justify-content-between"
                                ...
                                <div class="page-title-right">
                                    <a href="{{ route('bailleursDeFonds') }}"
                                        class="btn btn-outline-primary rounded-pill me-1 mb-1 btn-sm"><i
                    ...
                    <div class="col-xl-5">
                        <div class="card">
                            <div class="card-header page-title-box d-sm-flex align-items-center justify-content-between"
                                style="padding: 0.40rem 1rem;">
                                <h5 class="card-title mb-0"><i class="fa fa-info-circle"></i> Progression d'exécution du
                                    projet</h5>
                            </div>
                            <div class="card-body pt-0 pb-3">
                                <div id="overview-chart" data-colors='["#1f58c7"]' class="apex-charts" dir="ltr">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header page-title-box d-sm-flex align-items-center justify-content-between"
                                ...
                                <h4 class="mb-sm-0"><i class="fa fa-list"></i> Classment Exercice </h4>
                                <div class="page-title-right">
                                    <a href="{{ route('new.exercice', $cryptedProjectId) }}"
                                        class="btn btn-outline-primary rounded-pill me-1 mb-1 btn-sm"><i
                                            class="fa fa-plus-circle"></i> Ajouter</a>
                            ...
                            <div class="card-body pt-2">
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @forelse ($exercices as $exercice)
                                                <tr>
                                                    ...
                                                    <td align="right">{{ number_format($exercice->budget, 0, ',', ' ') }}
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="modal fade" id="confirmationModal" tabindex="-1"
                                        aria-labelledby="confirmationModalModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                    <p class="text-700 lh-lg mb-0">
                                                        <center>
                                                            ...
                                                            <font size="10" color="#c0c0c0"> <i
                                                                    class="fas fa-info-circle "></i></font>
                                                            <h5 class="modal-title" id="confirmationModalLabel">Confirmer
                                                                l'action ?</h5>

                                                            <font size="4"> Voulez-vous aller sur l'exercice <br>
                                                                numéro <b><span id="modalNumero"></span>/<span
                                                                        id="modalYear"></span></b>
                                                                du budget <b><span id="modalBudget"></span></b>
                                                            </font> <br> <br>
                                                            <button type="button" class="btn btn-danger"
                                                                data-bs-dismiss="modal"><i class="fa fa-times-circle"></i>
                                                                Non</button>
                                                            <a id="confirmLink" href="#" class="btn btn-primary"><i
                                                                    class="fa fa-check-circle"></i> Oui</a>
                                                        </center>
                                                    </p>
                                                </div>
                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="avatar-xs">
                                                            ...
                                                            @if (file_exists($imagePath) && $avatar)
                                                                <img id="output_image" src="{{ asset($avatar) }}"
                                                                    alt="{{ ucfirst($intervennant->nom) }}'s avatar"
                                                                    style="width:100%; border-radius:100%">
                                                            @else
                                                                <img id="output_image" src="{{ asset($defaultAvatar) }}"
                                                                    alt="{{ ucfirst($intervennant->nom) }}'s avatar"
                                                                    style="width:100%; border-radius:100%">
                                                            @endif
                                                        </div>
                                                    ...
                                                    <td>
                                                        <h5 class="font-size-14 m-0">
                                                            <a href="javascript: void(0);"
                                                                class="text-dark">{{ ucfirst($intervennant->nom) }}
                                                                {{ ucfirst($intervennant->prenom) }}</a>
                                                        </h5>
                                                    </td>
                                                    <td>
                                                        ...
                                                        @else
                                                            <i
                                                                class="mdi mdi-circle-medium font-size-18 text-danger align-middle me-1"></i>
                                                            Offline
                                                        @endif
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td colspan="3">
                                                        <center>
                                                            <h6 style="margin-top:1%; color:#c0c0c0">
                                                                <font size="20px"><i class="fa fa-info-circle"></i>
                                                                </font><br>
                                                                Ceci est vide !
                                                            </h6>
                                                        </center>
        ...
        $(function() {
            ...
            $(document).on('click', '.deleteIcon', function(e) {
                ...
                Swal.fire({
                    ...
                    html: "<p class='swal-text'>Cette action entraînera la suppression du projet <b>" +
                        title +
                        "</b></p><p class='swal-text'><i class='fa fa-info-circle' style='color: red;'></i> Ceci implique aussi la suppression de toutes les activités, lignes de compte budgétaire, budgets, FEB, DAP, DJA, bons de petites caisses, intervenants, plans d'action et feuilles de temps liés à ce projet.</p>",
