...
<div class="modal fade" id="modifierLigneModal" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addDealModal" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-sm-6 col-lg-12 col-xl-6">
              ...
              <input type="hidden" name="r_idr" id="r_idr" />
            </div>
          </div>
        </div>
        <div class="modal-footer">
